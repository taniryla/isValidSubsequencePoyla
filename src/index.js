...
// determine if the 2nd array is subsequence of the first array
...
// what happens if a string is inputed?

// 2. Progress to more complex examples. What is your updated plan here to find a solution?
...
function isValidSubsequence(array, sequence) {
  // two objects
  // two for of loops and a for in loop
